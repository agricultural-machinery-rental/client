...
export const validationPattern: Record<validationTypes, TValidation> = {
  name: {
     ...
     * */
    value: /^([А-яЁё]{2,16})$/,
    message: 'Должно состоять из кириллицы и содержать от 2 до 16 символов.',
  },
  phoneOrEmail: {
  ...
  date: {
    ...
    value: /^(0[1-9]|[12][0-9]|3[01])\.(0[1-9]|1[0-2])\.(19\d{2}|20(0[0-9]|10))$/,
    message: 'Дата должна быть в формате ДД.ММ.ГГГГ (например, 01.01.1990).',
  },
};
