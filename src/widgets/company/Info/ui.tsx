...
import {
  ...
  StAdvantageItem,
  AboutImageWrap,
  StSectionCompanyInfo,
  StCompanyAdvantagesWrap,
} from './styled';
    ...
    <>
      <section>
        <StCompanyInfoWrap>
          ...
          <StParagraph>
            Наша компания специализируется на предоставлении сельскохозяйственной техники в аренду.
            Мы гордимся тем, что уже более 15 лет помогаем фермерам и аграрным предприятиям улучшать
            их производственные процессы и повышать эффективность работы.
          </StParagraph>
          <StParagraph>
        ...
        <StCompanyAdvantagesWrap>
          ...
          <StAdvantagesListWrap>
            ...
            <StAdvantagesList>
              ...
              <StAdvantageItem>
                Качественная и надежная техника: Весь наш парк сельскохозяйственной техники
                регулярно проходит обслуживание и проверку, чтобы гарантировать отличную
                работоспособность и минимальные риски поломок на поле.
              </StAdvantageItem>
              <StAdvantageItem>
                Профессиональное обслуживание: Наша команда опытных специалистов всегда готова
                помочь вам с выбором и настройкой необходимой техники, а также предоставить
                консультации и техническую поддержку в процессе аренды.
              </StAdvantageItem>
              <StAdvantageItem>
